...
* *lbl_tv*: Its value is the label of the button to show `tv` list; **required**
* *lbl_ova*: Its value is the label of the button to show `ova/ona/special` list; **required**
* *lbl_movie*: Its value is the label of the button to show `movie` list; **required**
...
* an *image* from MyAnimeList link (or livechart exceptionally); **required**; show it when click on the button
